    ...
    <div class="hero-section background-is-dark" >
        <div class="wrapper">
            <div class="hero-title">
                <div class="container">
                    <h1 class="animate">Orinoco Forestry Products</h1>
        ...
        <!--end wrapper-->
        <div class="owl-carousel owl-theme" data-owl-dots="1" data-owl-nav="1" data-owl-autoplay="1" data-owl-loop="1" data-owl-fadeout="1">
            <div class="hero-slide">
                <div class="bg-transfer"><img src="{{ asset('img/gallery-big-04.jpg')}}" alt=""></div>
            </div>
            <div class="hero-slide">
                <div class="bg-transfer"><img src="{{ asset('img/gallery-big-05.jpg')}}" alt=""></div>
            </div>
            <div class="hero-slide">
                <div class="bg-transfer"><img src="{{ asset('img/gallery-big-06.jpg')}}" alt=""></div>
            </div>
            <div class="hero-slide">
                <div class="bg-transfer"><img src="{{ asset('img/gallery-big-07.jpg')}}" alt=""></div>
            </div>
        </div>
        <!--end owl-carousel-->
    </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="feature has-icon" data-scroll-reveal="enter bottom and move 20px">
                        ...
                        <div class="description">
                            ...
                            <p>Venezuela como nuestra central de operaciones y oficinas comerciales
                            en Estados Unidos y Paraguay</p>
                            <a href="#ubicacion" class="btn btn-default btn-rounded arrow">Donde Estamos</a>
                        </div>
                        <!--end description-->
                    </div>
                    <!--end feature-->
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="feature has-icon" data-scroll-reveal="enter right and move 20px">
                        ...
                        <div class="description">
                            ...
                            <a href="#estrategia" class="btn btn-default btn-rounded arrow">Propuesta de Valor</a>
                        </div>
                        <!--end description-->
                    </div>
                    <!--end feature-->
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <!--Nuestro negocio se basa en la generación y
                        ...
                        provenientes de bosques plantados de <em>Pinus
                        caribaea Morelet var. hondurensis</em>, destacando
                        ...
                        nuestros clientes.-->
                        Somos una empresa venezolana de carácter privado, constituida para generar valor a nuestros clientes, colaboradores y accionistas a través de nuestros productos y servicios. Nuestra empresa se especializa en la producción y comercialización de productos forestales de remanufactura, empleando como materia prima el pino caribe <em>(Pinus caribaea Morelet Var. Hondurensis)</em>, disponible en plantaciones forestales ubicadas en el oriente venezolano. 
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3">
                    <div class="stage completed" data-scroll-reveal="enter left and move 20px after 0.2s">
                        ...
                        <div class="description">
                            ...
                            <figure>Recursos naturales</figure>
                        </div>
                        <!--end description-->
                    </div>
                    <!--end stage-->
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="stage completed" data-scroll-reveal="enter left and move 20px after 0.4s">
                        <div class="icon">
                        ...
                        <div class="description">
                            <h2>3. Económico</h2>
                            <h3>Producción</h3>
                            <figure>Comercialización</figure>
                        </div>
                        <!--end description-->
                    </div>
                    <!--end stage-->
                    ...
                    <div class="col-md-5 col-sm-5">
                        <div class="description">
                            ...
                            <p style="font-size: 17px;text-align: justify;">Obtener la confianza y fidelidad de nuestros
                                clientes,agregando valor a nuestros productos y servicios,
                    ...
                    <div class="col-md-10 col-sm-10 col-md-offset-1 col-sm-offset-1">
                        <div class="owl-carousel" data-owl-nav="0" data-owl-dots="1">
                            <blockquote>
                                ...
                                <footer>Orinoco Forestry Products</footer>
                            </blockquote>
                            <!--end blockquote-->
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 text-center">
                                    ...
                                    <div class="social">
                                        ...
                                        <a href="https://twitter.com/@orinocoforestry"><i class="social_twitter_circle"></i>Twitter</a>
                                        <a href="https://www.instagram.com/orinocoforestry/"><i class="social_instagram_circle"></i>@orinocoforestry</a>
    ...
    <div class="block" id="ubicacion">
        <div class="container">
            ...
            <div class="detail right-align">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <img src="{{ asset('img/locationOFP.png')}}" alt="">
                    </div>
                    <!--end col-md-7-->
                    ...
                    <div class="col-md-5 col-sm-5">
                        <div class="person">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 text-center">
                                    <div class="description">
                                        <p style="font-size: 17px;text-align: justify;">Venezuela, aquí radica nuestra 
                                            operación central, en este país desarrollamos actividades de producción
                                            destinadas a generar valor agregado complementario a distintos tipos de
                                            productos forestales provenientes de bosques plantados, para ser colocados
                                            en mercados internacionales. Paraguay, oficina comercial. Estados Unidos, 
                                            oficina comercial. 
                                        </p>    
                                    </div>
                                    <!--end social-->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="title">
                    <h4>Building A</h4>
                    <h3>Floor 3</h3>
                    <h1 class="modal-title">Apartmeghjdgjdfghgfhjnt 01</h1>
                    <h2>$69,000</h2>
                </div>
            </div>
            <!--end modal-header-->
